...
description: The design decisions behind Stagecoach, each answering a failure mode.
question: What is Stagecoach, and why is it designed this way?
---
...
Stagecoach takes one task from a written plan to a draft pull request.
...
Stagecoach started from spec-driven development, in the spirit of [GitHub Spec Kit](https://developer.microsoft.com/blog/spec-driven-development-spec-kit/): specify first, then implement.
