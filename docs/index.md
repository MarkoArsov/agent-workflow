...
template: home.html
title: Overview
description: Agents write the code. Stagecoach makes them prove it, with an open-source runner that checks every stage.
---

<section class="home-hero" aria-labelledby="home-title">
  <div class="home-hero-copy">
    <p class="home-kicker">OPEN SOURCE · MIT · CLAUDE CODE · CODEX · CURSOR</p>
    <h1 id="home-title">Agents write the code. Stagecoach makes them prove it.</h1>
  ...
  <div class="run-panel" aria-label="Example Stagecoach run">
    ...
    <div class="run-command"><span>$</span> agent-workflow status csv-export</div>
...
<section class="home-problem" aria-labelledby="problem-title">
  ...
  <p class="home-closing-line">Writing code stopped being the hard part. Proving a change is right is the new bottleneck, and Stagecoach is built around it. <a class="text-link" href="why/">Read the research <span aria-hidden="true">→</span></a></p>
</section>
...
<section class="home-scorecard" aria-labelledby="scorecard-title">
  <div class="section-intro">
    ...
    <p>Most tools tell you they're safe. Stagecoach publishes the scorecard: what the runner enforces, what's partial, what belongs to your organization, and what's still open.</p>
  </div>
<!-- scorecard: grid -->
...
<section class="home-open" aria-labelledby="open-title">
  ...
  <div class="tile-grid">
    ...
    <div class="tile"><h3>Runs on your machine</h3><p>Your agent CLIs, your logins, your repositories. No Stagecoach account, server, or telemetry.</p></div>
...
<section class="home-split" aria-labelledby="review-title">
  <div class="section-intro">
    ...
    <h2 id="review-title">Review is the new bottleneck. Stagecoach treats it that way.</h2>
