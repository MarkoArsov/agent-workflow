...
footer: docs
footer_order: 2
question: How do I configure Scorebook for my repositories?
---

# Set up your project

!!! summary "In one minute"
    - Invoke `sb-project-setup` in your agent. It reads your repositories and reports what it found, with sources.
...
Open the intended repository or multi-repository parent and invoke **sb-project-setup**
(**scorebook:project-setup** in the native Claude plugin).
...
~~~sh
scorebook setup . --output /tmp/workflow-proposal.json
~~~
...
~~~sh
scorebook setup --apply /tmp/workflow-proposal.json --approve APPROVED_DIGEST
~~~
