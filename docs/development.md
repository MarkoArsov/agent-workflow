...
description: Contribute to Stagecoach, run its checks, and change a public contract safely.
question: How do I contribute to Stagecoach?
---

# Contribute and develop

!!! summary "In one minute"
    - Stagecoach is MIT-licensed and developed in the open. Contributions are welcome.
