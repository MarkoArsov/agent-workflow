...
The versioned JSON profile lives in .agent-workflow/project.json. PROJECT_WORKFLOW.md explains it for people and agents. A project may contain one repository or several sibling repositories. Registration is explicit; neighboring folders are not automatically part of a task.
