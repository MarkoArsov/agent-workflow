...
!!! summary "In one minute"
    - Stagecoach is MIT-licensed. Everything that runs is in the public repository.
    - It runs locally with your own agent CLIs. There is no Stagecoach account, server, or telemetry.
...
| Folder | What it is |
|---|---|
| [`runtime/agent_workflow/`](https://github.com/MarkoArsov/agent-workflow/tree/main/runtime/agent_workflow) | The runner, check parsers, path and rule guards, run journal, provider commands, environments, and delivery. See the [code map](code-map.md). |
...
With Stagecoach you can read exactly what "passed" means:
...
Stagecoach is released under the [MIT license](https://github.com/MarkoArsov/agent-workflow/blob/main/LICENSE): use it, change it, and ship it, keeping the copyright and license notice.
